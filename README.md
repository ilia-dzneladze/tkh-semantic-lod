...
python -m pip install torch==2.14.0 --index-url https://download.pytorch.org/whl/cpu   # Linux only
...
every budget; a one-command rerun reproduces every output byte for byte.
